...
public class HelloWorld extends PApplet {
	...
	public void setup() {
		...
		// The next line zooms in and centers the map at (32.9, -117.2).
		map1.zoomAndPanTo(zoomLevel, new Location(32.9f, -117.2f));

		// This line makes the map interactive
		MapUtils.createDefaultEventDispatcher(this, map1);

		// TODO: Add code here that creates map2 ,then you'll modify draw() below.
		map2 = new UnfoldingMap(this, 425, 25, 350, 550, provider);
		map2.zoomAndPanTo(zoomLevel, new Location(34.06f, -118.48f));

...
public class CityMarker extends SimplePointMarker {	
	public static final int SIZE = 5;    // The size of the triangle marker. It's a good idea to use this variable in your draw method
	public CityMarker(Location location) {		// constructor 1
		super(location);
	}	
	public CityMarker(Feature city) {		//constructor 2
	 ...
	 * Float x and y are the center of the object to draw (central point of the triangle). 

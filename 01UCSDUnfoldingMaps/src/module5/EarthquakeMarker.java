...
public abstract class EarthquakeMarker extends CommonMarker{		
	 ...
	 */
	protected float radius;			/** constants for distance */
	...
	public abstract void drawEarthquake(PGraphics pg, float x, float y);		/** abstract method implemented in derived classes */
	...
	public void showTitle(PGraphics pg, float x, float y){
		String display = (String)this.getProperty("title");
		pg.fill(200);
		pg.rect(x, y, pg.textWidth(display), 20);
		pg.fill(0);
		pg.text(display,x,y+13);		
	}
	
	
	/*
	 * Return the "threat circle" radius, or distance up to which this earthquake can affect things, for this earthquake.   

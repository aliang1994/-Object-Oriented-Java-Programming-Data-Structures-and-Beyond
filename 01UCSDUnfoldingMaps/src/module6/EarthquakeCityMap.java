...
public class EarthquakeCityMap extends PApplet {
	...
	*/
	...
	private void sortAndPrint(int numToPrint){ // two ways of sorting
		 EarthquakeMarker[] quakeArray = new EarthquakeMarker[quakeMarkers.size()]; 
		 quakeMarkers.toArray(quakeArray);		
		 Arrays.sort(quakeArray);
		 
		 List<EarthquakeMarker> troll = new ArrayList<EarthquakeMarker>();
		 for(int k=0; k<quakeMarkers.size(); k++){
			 troll.add((EarthquakeMarker)quakeMarkers.get(k));
		 }
		 Collections.sort(troll); 
		 
		 for (int m=0; m<numToPrint; m++){
			 System.out.println(quakeArray[m]);			 
		 }
		 System.out.println("-----------------------------------------------------");	
		 for (int i=0; i<numToPrint; i++){
			 System.out.println(troll.get(i));			 
		 }
	}	
	...
	public void keyPressed(){
		if(keyPressed){			
			for(Marker qm: quakeMarkers){
				...
				String age = qm.getStringProperty("age");
	...
	*/
	private void addKey() {	
		...
		stroke(100);
		rect(xbase+35-5, ybase+140-5, 10, 10);
		//ellipse(xbase+35, ybase+140, 12, 12);
		fill(color(255, 0, 0));
		rect(xbase+35-5, ybase+160-5, 10, 10);
		//ellipse(xbase+35, ybase+160, 12, 12);
		fill(color(70, 0, 0));
		rect(xbase+35-5, ybase+180-5, 10, 10);
		...
		rect(centerx-6, centery-6, 12, 12);

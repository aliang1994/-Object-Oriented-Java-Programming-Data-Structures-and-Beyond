...
public abstract class EarthquakeMarker extends CommonMarker implements Comparable<EarthquakeMarker>{
	...
	protected float radius;  // The radius of the Earthquake marker. You will want to set this in the constructor, either using the thresholds below, or a continuous function based on magnitude. 
	protected static final float kmPerMile = 1.6f; // constants for distance

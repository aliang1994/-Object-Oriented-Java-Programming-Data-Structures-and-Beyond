...
public class EfficientDocument extends Document {
	...
	private void processText(){
		// Ignore everything that is not a word or a sentence-ending punctuation.
		...
		for (String word: tokens){
			if(isWord(word)==true){
				wordCount ++;	
				int sylInOneWord = countSyllables(word);
				sylCount += sylInOneWord;
			}	
			else{
				sentCount++;
			}
		...
		numWords = wordCount;
		numSyllables = sylCount;
		numSentences = sentCount;	
